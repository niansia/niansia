...
我是**元智大学（YZU）计算机科学专业**应届毕业生，主要关注 **AI 安全、计算机视觉与视觉语言模型**的交叉领域，尤其是可靠的多模态推理与模型评估。
...
| **[房贷决策支持](https://github.com/niansia/1113354_MortgageCalculator)** | 结合蒙特卡洛压力测试、情景比较与风险指标的财务决策工具。 | 量化建模、模拟、C# |
